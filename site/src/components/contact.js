    ...
    render(){
        return(
            <div className="w3-container w3-content w3-padding-64" style={{maxWidth:'800px'}} id="contact">
                ...
                <p className="w3-opacity w3-center"><i>Want to talk? Drop a note!</i></p>
                <div className="w3-row w3-padding-32">
                    <div className="w3-center w3-margin-bottom">
                        <i className="fa fa-map-marker" style={{width:'30px'}}></i> California, US<br/>
                        <i className="fa fa-phone" style={{width:'30px'}}></i> Phone: (562) 506-3776<br/>
                        <i className="fa fa-envelope" style={{width:'30px'}}> </i> Email: matt.ipavec@gmail.com<br/>
                    </div>
